...
def dynamatic_types : AssocList String (String × List (Option Nat) × List (Option Nat)) :=
  ...
  , ("operator1", ("Operator", [.none], [.none]))
  , ("operator2", ("Operator", List.replicate 2 .none, [.none]))
  , ("operator3", ("Operator", List.replicate 3 .none, [.none]))
  , ("operator4", ("Operator", List.replicate 4 .none, [.none]))
  , ("operator5", ("Operator", List.replicate 5 .none, [.none]))
