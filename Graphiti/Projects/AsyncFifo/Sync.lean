...
theorem case_0 (s) (i mid : syncT) (H : ψ i s)
    (Hrule : (syncNetlist.internals.getD 0 (fun _ _ => False)) i mid) :
    ∃ s', existSR syncSpec.internals s s' ∧ ψ mid s' := by sync_case

theorem case_1 (s) (i mid : syncT) (H : ψ i s)
    (Hrule : (syncNetlist.internals.getD 1 (fun _ _ => False)) i mid) :
    ∃ s', existSR syncSpec.internals s s' ∧ ψ mid s' := by sync_case

theorem case_2 (s) (i mid : syncT) (H : ψ i s)
    (Hrule : (syncNetlist.internals.getD 2 (fun _ _ => False)) i mid) :
    ∃ s', existSR syncSpec.internals s s' ∧ ψ mid s' := by sync_case

theorem case_3 (s) (i mid : syncT) (H : ψ i s)
    (Hrule : (syncNetlist.internals.getD 3 (fun _ _ => False)) i mid) :
    ∃ s', existSR syncSpec.internals s s' ∧ ψ mid s' := by sync_case

theorem case_4 (s) (i mid : syncT) (H : ψ i s)
