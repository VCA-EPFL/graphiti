...
window followed by a sampling window.  Since the filtered domains are what the timed
implementations of `Timed.lean` refine, this is the theorem every lower stage plugs into.
