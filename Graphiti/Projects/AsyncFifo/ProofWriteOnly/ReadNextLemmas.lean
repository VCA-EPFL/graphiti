...
Facts about the definitions in `components/level4/ReadNext.lean`.  The statement of the
...
abbrev gateNextRT : Type :=
  (List (RSt 2) × List (BitVec 3)) × List Bool × List Bool × (List Bool × List Bool) × List Bool × List Bool × List Bool × List Bool × (List Bool × List Bool) × (List Bool × List Bool) × List Bool × (List Bool × List Bool) × (List Bool × List Bool) × (List Bool × List Bool) × List Bool × List Bool × List Bool × (List Bool × List Bool) × (List Bool × List Bool) × List Bool × (List Bool × List Bool) × List Bool × (List Bool × List Bool) × (List Bool × List Bool) × (List Bool × List Bool) × (List Bool × List Bool) × (List Bool × List Bool) × (List Bool × List Bool) × PackSt
...
theorem gateNextR_sigma :
    (⟨_, gateNextR⟩ : Σ T, StringModule T) = ExprLow.build_module genv.find? gateNextRExpr := by
...
def W_unp_p0 (s : ReadNext.RNextSt 2) : List Bool := List.map (fun x => x.ptr.getLsbD 0) s.st
def W_unp_p1 (s : ReadNext.RNextSt 2) : List Bool := List.map (fun x => x.ptr.getLsbD 1) s.st
def W_unp_p2 (s : ReadNext.RNextSt 2) : List Bool := List.map (fun x => x.ptr.getLsbD 2) s.st
def W_unp_em (s : ReadNext.RNextSt 2) : List Bool := List.map (fun x => x.empty) s.st
def W_unp_q20 (s : ReadNext.RNextSt 2) : List Bool := List.map (fun x => x.q2.getLsbD 0) s.st
def W_unp_q21 (s : ReadNext.RNextSt 2) : List Bool := List.map (fun x => x.q2.getLsbD 1) s.st
def W_unp_q22 (s : ReadNext.RNextSt 2) : List Bool := List.map (fun x => x.q2.getLsbD 2) s.st
def W_unp_q10 (s : ReadNext.RNextSt 2) : List Bool := List.map (fun x => x.getLsbD 0) s.q1
def W_unp_q11 (s : ReadNext.RNextSt 2) : List Bool := List.map (fun x => x.getLsbD 1) s.q1
def W_unp_q12 (s : ReadNext.RNextSt 2) : List Bool := List.map (fun x => x.getLsbD 2) s.q1
def W_nem (s : ReadNext.RNextSt 2) : List Bool := gate1Out not (W_unp_em s)
def W_ok (s : ReadNext.RNextSt 2) : List Bool := gateOut Bool.and (s.inc) (W_nem s)
def W_xp0 (s : ReadNext.RNextSt 2) : List Bool := gateOut Bool.xor (W_unp_p0 s) (W_ok s)
def W_cp0 (s : ReadNext.RNextSt 2) : List Bool := gateOut Bool.and (W_unp_p0 s) (W_ok s)
def W_xp1 (s : ReadNext.RNextSt 2) : List Bool := gateOut Bool.xor (W_unp_p1 s) (W_cp0 s)
def W_cp1 (s : ReadNext.RNextSt 2) : List Bool := gateOut Bool.and (W_unp_p1 s) (W_cp0 s)
def W_xp2 (s : ReadNext.RNextSt 2) : List Bool := gateOut Bool.xor (W_unp_p2 s) (W_cp1 s)
def W_xg0 (s : ReadNext.RNextSt 2) : List Bool := gateOut Bool.xor (W_xp1 s) (W_xp0 s)
def W_xg1 (s : ReadNext.RNextSt 2) : List Bool := gateOut Bool.xor (W_xp2 s) (W_xp1 s)
def W_xu1 (s : ReadNext.RNextSt 2) : List Bool := gateOut Bool.xor (W_unp_q22 s) (W_unp_q21 s)
def W_xu0 (s : ReadNext.RNextSt 2) : List Bool := gateOut Bool.xor (W_xu1 s) (W_unp_q20 s)
def W_xe2 (s : ReadNext.RNextSt 2) : List Bool := gateOut (fun a b => a == b) (W_xp2 s) (W_unp_q22 s)
def W_xe1 (s : ReadNext.RNextSt 2) : List Bool := gateOut (fun a b => a == b) (W_xp1 s) (W_xu1 s)
def W_xe0 (s : ReadNext.RNextSt 2) : List Bool := gateOut (fun a b => a == b) (W_xp0 s) (W_xu0 s)
def W_ae (s : ReadNext.RNextSt 2) : List Bool := gateOut Bool.and (W_xe2 s) (W_xe1 s)
def W_am (s : ReadNext.RNextSt 2) : List Bool := gateOut Bool.and (W_ae s) (W_xe0 s)

/-- The packer's stored inputs when every wire carries its full stream. -/
def Wpk (s : ReadNext.RNextSt 2) : PackSt := ⟨W_xp0 s, W_xp1 s, W_xp2 s, W_am s, W_unp_q10 s, W_unp_q11 s, W_unp_q12 s, W_xg0 s, W_xg1 s, W_xp2 s, W_unp_p0 s, s.inc, W_unp_q10 s⟩
def W_pack (s : ReadNext.RNextSt 2) : List (RNext 2) := packROut (Wpk s)
...
theorem C_inc : Comb 0 0 F_inc (ReadNext.rnextDep s) s.inc := Comb.input (fun t _ => rfl)
theorem C_unp_p0 : Comb 0 0 F_unp_p0 (ReadNext.rnextDep s) (W_unp_p0 s) :=
  Comb.input (fun t ht => by unfold W_unp_p0 at ht ⊢; rw [getD_map_lt _ _ (by simpa using ht)]; rfl)
theorem C_unp_p1 : Comb 0 0 F_unp_p1 (ReadNext.rnextDep s) (W_unp_p1 s) :=
  Comb.input (fun t ht => by unfold W_unp_p1 at ht ⊢; rw [getD_map_lt _ _ (by simpa using ht)]; rfl)
theorem C_unp_p2 : Comb 0 0 F_unp_p2 (ReadNext.rnextDep s) (W_unp_p2 s) :=
  Comb.input (fun t ht => by unfold W_unp_p2 at ht ⊢; rw [getD_map_lt _ _ (by simpa using ht)]; rfl)
theorem C_unp_em : Comb 0 0 F_unp_em (ReadNext.rnextDep s) (W_unp_em s) :=
  Comb.input (fun t ht => by unfold W_unp_em at ht ⊢; rw [getD_map_lt _ _ (by simpa using ht)]; rfl)
theorem C_unp_q20 : Comb 0 0 F_unp_q20 (ReadNext.rnextDep s) (W_unp_q20 s) :=
  Comb.input (fun t ht => by unfold W_unp_q20 at ht ⊢; rw [getD_map_lt _ _ (by simpa using ht)]; rfl)
theorem C_unp_q21 : Comb 0 0 F_unp_q21 (ReadNext.rnextDep s) (W_unp_q21 s) :=
  Comb.input (fun t ht => by unfold W_unp_q21 at ht ⊢; rw [getD_map_lt _ _ (by simpa using ht)]; rfl)
theorem C_unp_q22 : Comb 0 0 F_unp_q22 (ReadNext.rnextDep s) (W_unp_q22 s) :=
  Comb.input (fun t ht => by unfold W_unp_q22 at ht ⊢; rw [getD_map_lt _ _ (by simpa using ht)]; rfl)
theorem C_unp_q10 : Comb 0 0 F_unp_q10 (ReadNext.rnextDep s) (W_unp_q10 s) :=
  Comb.input (fun t ht => by unfold W_unp_q10 at ht ⊢; rw [getD_map_lt _ _ (by simpa using ht)]; rfl)
theorem C_unp_q11 : Comb 0 0 F_unp_q11 (ReadNext.rnextDep s) (W_unp_q11 s) :=
  Comb.input (fun t ht => by unfold W_unp_q11 at ht ⊢; rw [getD_map_lt _ _ (by simpa using ht)]; rfl)
theorem C_unp_q12 : Comb 0 0 F_unp_q12 (ReadNext.rnextDep s) (W_unp_q12 s) :=
  Comb.input (fun t ht => by unfold W_unp_q12 at ht ⊢; rw [getD_map_lt _ _ (by simpa using ht)]; rfl)
theorem C_nem : Comb 1 1 F_nem (ReadNext.rnextDep s) (W_nem s) :=
  Comb.gate1 not (C_unp_em s)
theorem C_ok : Comb 1 2 F_ok (ReadNext.rnextDep s) (W_ok s) :=
  Comb.gate2 Bool.and (C_inc s) (C_nem s)
theorem C_xp0 : Comb 1 3 F_xp0 (ReadNext.rnextDep s) (W_xp0 s) :=
  Comb.gate2 Bool.xor (C_unp_p0 s) (C_ok s)
theorem C_cp0 : Comb 1 3 F_cp0 (ReadNext.rnextDep s) (W_cp0 s) :=
  Comb.gate2 Bool.and (C_unp_p0 s) (C_ok s)
theorem C_xp1 : Comb 1 4 F_xp1 (ReadNext.rnextDep s) (W_xp1 s) :=
  Comb.gate2 Bool.xor (C_unp_p1 s) (C_cp0 s)
theorem C_cp1 : Comb 1 4 F_cp1 (ReadNext.rnextDep s) (W_cp1 s) :=
  Comb.gate2 Bool.and (C_unp_p1 s) (C_cp0 s)
theorem C_xp2 : Comb 1 5 F_xp2 (ReadNext.rnextDep s) (W_xp2 s) :=
  Comb.gate2 Bool.xor (C_unp_p2 s) (C_cp1 s)
theorem C_xg0 : Comb 2 5 F_xg0 (ReadNext.rnextDep s) (W_xg0 s) :=
  Comb.gate2 Bool.xor (C_xp1 s) (C_xp0 s)
theorem C_xg1 : Comb 2 6 F_xg1 (ReadNext.rnextDep s) (W_xg1 s) :=
  Comb.gate2 Bool.xor (C_xp2 s) (C_xp1 s)
theorem C_xu1 : Comb 1 1 F_xu1 (ReadNext.rnextDep s) (W_xu1 s) :=
  Comb.gate2 Bool.xor (C_unp_q22 s) (C_unp_q21 s)
theorem C_xu0 : Comb 1 2 F_xu0 (ReadNext.rnextDep s) (W_xu0 s) :=
  Comb.gate2 Bool.xor (C_xu1 s) (C_unp_q20 s)
theorem C_xe2 : Comb 1 6 F_xe2 (ReadNext.rnextDep s) (W_xe2 s) :=
  Comb.gate2 (fun a b => a == b) (C_xp2 s) (C_unp_q22 s)
theorem C_xe1 : Comb 2 5 F_xe1 (ReadNext.rnextDep s) (W_xe1 s) :=
  Comb.gate2 (fun a b => a == b) (C_xp1 s) (C_xu1 s)
theorem C_xe0 : Comb 2 4 F_xe0 (ReadNext.rnextDep s) (W_xe0 s) :=
  Comb.gate2 (fun a b => a == b) (C_xp0 s) (C_xu0 s)
theorem C_ae : Comb 2 7 F_ae (ReadNext.rnextDep s) (W_ae s) :=
  Comb.gate2 Bool.and (C_xe2 s) (C_xe1 s)
theorem C_am : Comb 3 8 F_am (ReadNext.rnextDep s) (W_am s) :=
...
theorem pack_identity' (ptr q2 q1 : BitVec 3) (empty inc : Bool) :
  ...
  rw [show ReadNext.rnextFun ((⟨ptr, empty, q2⟩ : RSt 2), inc, q1) = ⟨⟨(ReadNext.rnextFun ((⟨ptr, empty, q2⟩ : RSt 2), inc, q1)).st.ptr, (ReadNext.rnextFun ((⟨ptr, empty, q2⟩ : RSt 2), inc, q1)).st.empty, (ReadNext.rnextFun ((⟨ptr, empty, q2⟩ : RSt 2), inc, q1)).st.q2⟩, (ReadNext.rnextFun ((⟨ptr, empty, q2⟩ : RSt 2), inc, q1)).gnext⟩ from rfl]
  rw [h_st_ptr, h_st_empty, h_st_q2, h_gnext]

theorem pack_identity (i : Inp) : (⟨⟨bv3 (F_xp0 i) (F_xp1 i) (F_xp2 i), F_am i, bv3 (F_unp_q10 i) (F_unp_q11 i) (F_unp_q12 i)⟩, bv3 (F_xg0 i) (F_xg1 i) (F_xp2 i)⟩ : RNext 2) = ReadNext.rnextFun i := by
...
theorem W_pack_length : (W_pack s).length ≤ ReadNext.rnextLen s := by
  simp only [W_pack, packROut_length, Wpk, refLen, W_unp_p0, W_unp_q10, List.length_map, ReadNext.rnextLen]
  exact Nat.min_le_right _ _

/-- **The netlist satisfies the contract of the next-state block** with delay window `[0, 8]`. -/
theorem W_pack_comb : CombOut (ReadNext.rnextDep s) (ReadNext.rnextFun) (ReadNext.rnextLen s) 0 8 (W_pack s) := by
...
instance : MatchInterface gateNextR (ReadNext.nextSpec (n := 2) 0 8) := by
  dsimp [gateNextR, ReadNext.nextSpec]
