...
theorem gateNext_internals_eq : gateNext.internals =
    [gateNext.internals.getD 0 (fun _ _ => False), gateNext.internals.getD 1 (fun _ _ => False), gateNext.internals.getD 2 (fun _ _ => False),
     gateNext.internals.getD 3 (fun _ _ => False), gateNext.internals.getD 4 (fun _ _ => False), gateNext.internals.getD 5 (fun _ _ => False),
     gateNext.internals.getD 6 (fun _ _ => False), gateNext.internals.getD 7 (fun _ _ => False), gateNext.internals.getD 8 (fun _ _ => False),
     gateNext.internals.getD 9 (fun _ _ => False), gateNext.internals.getD 10 (fun _ _ => False), gateNext.internals.getD 11 (fun _ _ => False),
     gateNext.internals.getD 12 (fun _ _ => False), gateNext.internals.getD 13 (fun _ _ => False), gateNext.internals.getD 14 (fun _ _ => False),
     gateNext.internals.getD 15 (fun _ _ => False), gateNext.internals.getD 16 (fun _ _ => False), gateNext.internals.getD 17 (fun _ _ => False),
     gateNext.internals.getD 18 (fun _ _ => False), gateNext.internals.getD 19 (fun _ _ => False), gateNext.internals.getD 20 (fun _ _ => False),
     gateNext.internals.getD 21 (fun _ _ => False), gateNext.internals.getD 22 (fun _ _ => False), gateNext.internals.getD 23 (fun _ _ => False),
     gateNext.internals.getD 24 (fun _ _ => False), gateNext.internals.getD 25 (fun _ _ => False), gateNext.internals.getD 26 (fun _ _ => False),
     gateNext.internals.getD 27 (fun _ _ => False), gateNext.internals.getD 28 (fun _ _ => False), gateNext.internals.getD 29 (fun _ _ => False),
     gateNext.internals.getD 30 (fun _ _ => False), gateNext.internals.getD 31 (fun _ _ => False), gateNext.internals.getD 32 (fun _ _ => False),
     gateNext.internals.getD 33 (fun _ _ => False), gateNext.internals.getD 34 (fun _ _ => False), gateNext.internals.getD 35 (fun _ _ => False),
     gateNext.internals.getD 36 (fun _ _ => False), gateNext.internals.getD 37 (fun _ _ => False), gateNext.internals.getD 38 (fun _ _ => False),
     gateNext.internals.getD 39 (fun _ _ => False), gateNext.internals.getD 40 (fun _ _ => False), gateNext.internals.getD 41 (fun _ _ => False),
     gateNext.internals.getD 42 (fun _ _ => False), gateNext.internals.getD 43 (fun _ _ => False), gateNext.internals.getD 44 (fun _ _ => False),
     gateNext.internals.getD 45 (fun _ _ => False), gateNext.internals.getD 46 (fun _ _ => False), gateNext.internals.getD 47 (fun _ _ => False),
     gateNext.internals.getD 48 (fun _ _ => False), gateNext.internals.getD 49 (fun _ _ => False), gateNext.internals.getD 50 (fun _ _ => False),
     gateNext.internals.getD 51 (fun _ _ => False)] := rfl
